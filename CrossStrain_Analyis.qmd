...
antibioticsPlot <- ggplot(antibiotica) +
  ...
  theme_minimal() +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1,size = 12,lineheight = 0.9,face = "bold"),
    axis.text.y = element_text(size = 12,lineheight = 0.9,face = "bold"),
    legend.text = element_text(size = 12,lineheight = 0.9),
    legend.title = element_text(size = 12,lineheight = 0.9),
    axis.title = element_text(size = 14,lineheight = 0.9,face = "bold"),
    plot.title = element_text(size = 12,lineheight = 0.9,face = "bold"),
    legend.box = "horizontal",
    legend.background = element_rect(fill = "#FAF9F6", linewidth = 0.5, linetype = "blank")
  ) +
  labs(
